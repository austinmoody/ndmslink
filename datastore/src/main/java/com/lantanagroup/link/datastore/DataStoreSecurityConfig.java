...
import com.lantanagroup.link.datastore.filter.IpFilter;
...
public class DataStoreSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        IpFilter ipFilter = new IpFilter(
                dataStoreConfig.isIpFilterEnabled(),
                dataStoreConfig.getAllowedIps()
        );
        ...
        http
                ...
                .and()
                .antMatcher("/**")
                .addFilterBefore(ipFilter, PreAuthTokenHeaderFilter.class)
